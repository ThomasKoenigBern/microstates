...
% [EEG,com] = pop_FindMSTemplates(EEG, struct('MinClasses', 4, 'MaxClasses', 10, 'GFPPeaks', 1, 'IgnorePolarity', 1, 'MaxMaps', 1000, 'Restarts', 25, 'UseAAHC', 0, 'Normalize', 1), 0, 0);
% [ALLEEG EEG] = eeg_store(ALLEEG, EEG, CURRENTSET);
toc
...
disp("Beginning calculating criteria");
tic
...
toc
disp("done calculating metacriteria");
