    % EEGLAB history file generated on the 24-Nov-2021
% ------------------------------------------------
...
EEG = eeg_checkset( EEG );
com = pop_QuantMSTemplates(ALLEEG, [1], 0, struct('b',0,'lambda',3.000000e-01,'PeakFit',1,'nClasses',3,'BControl',1,'Rectify',0,'Normalize',0), [], 0, 'C:\Program Files\MATLAB\R2021b\eeglab2021.1\results\quantify_results_dataset1_2.csv');
